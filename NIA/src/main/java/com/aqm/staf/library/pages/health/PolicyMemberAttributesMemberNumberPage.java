...
public class PolicyMemberAttributesMemberNumberPage extends BasePage {
	...
	public PolicyMemberAttributesMemberNumberPage (WebDriver driver, String pageName) {
	...
	public void fillPolicyMemberAttributesMemberNumberPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity, CustomAssert assertReference)throws InterruptedException{
		if(policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("add") || policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("edit")){
			...
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigMemberNumber")) {
				clearAndSendKeys(memberNumberTextField, policyMemberAttrGroupEntity.getStringValueForField("MemberNumber"));
			}
		}
	...
	public void proceedButtonPolicyMemberAttributesMemberNumberPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity){
	...
	public void submitPolicyMemberAttributesGroupNumber(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity) {
	...
	public void fillAndSubmitPolicyMemberAttributesMemberNumberPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity,CustomAssert assertReference)throws InterruptedException {
		if(isConfigTrue(policyMemberAttrGroupEntity.getConfigExecute())){
			switchToFrame("display");
			fillPolicyMemberAttributesMemberNumberPage(policyMemberAttrGroupEntity, assertReference);
			proceedButtonPolicyMemberAttributesMemberNumberPage(policyMemberAttrGroupEntity);
			submitPolicyMemberAttributesGroupNumber(policyMemberAttrGroupEntity);
