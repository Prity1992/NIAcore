...
public class PolicyMemberAttributesNextGroupPage extends BasePage {
	...
	private PageElement toWhichGroupTextField;
	private PageElement nextGroupDropdown;
	private PageElement groupNumberTextField;
	private PageElement memberNumberTextField;
	...
	public PolicyMemberAttributesNextGroupPage (WebDriver driver, String pageName) {
		...
		nextGroupDropdown=new PageElement(By.name("propValues2"), "Next Group DropDown", false, WaitType.WAITFORELEMENTTOBEEENABLED, 10);
		toWhichGroupTextField=new PageElement(By.name("propValues2"), "To Which Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		...
		memberNumberTextField=new PageElement(By.name("propValues1"), "To Which Text Field", false, WaitType.WAITFORELEMENTTOBEDISPLAYED, 10);
		nextButton=new PageElement(By.name("Next"), "Proceed Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
		backButton=new PageElement(By.name("Back"), "Back Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
		saveButton=new PageElement(By.name("Back"), "Back Button", false, WaitType.WAITFORELEMENTTOBECLICKABLE, 10);
	...
	public void fillPolicyMemberAttributeNextGroupPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity, CustomAssert assertReference)throws InterruptedException{
		if(policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("add") || policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("edit")){
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigNextGroup")) {
				selectValueFromList(nextGroupDropdown, policyMemberAttrGroupEntity.getStringValueForField("NextGroup"));
			}
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigToWhichGroup")) {
				clearAndSendKeys(toWhichGroupTextField, policyMemberAttrGroupEntity.getStringValueForField("ToWhichGroup"));
			}
		}
			...
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigNextGroup")) {
				assertReference.assertEquals(policyMemberAttrGroupEntity.getStringValueForField("NextGroup"), fetchValueFromTextFields(nextGroupDropdown), AssertionType.WARNING);
			}
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigToWhichGroup")) {
				assertReference.assertEquals(policyMemberAttrGroupEntity.getStringValueForField("ToWhichGroup"), fetchValueFromTextFields(toWhichGroupTextField), AssertionType.WARNING);
			}		
		}
	}
	
	public void fillGroupNumberDetails(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity,CustomAssert assertReference){
		if(policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("verify")){	
	...
	public void clickOnNextButton(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity){
	...
	public void fillMemberNumberDetails(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity,CustomAssert assertReference){
		if(policyMemberAttrGroupEntity.getAction().equalsIgnoreCase("verify")){
			if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigMemberNumber")) {
				assertReference.assertEquals(policyMemberAttrGroupEntity.getStringValueForField("MemberNumber"), fetchValueFromTextFields(memberNumberTextField), AssertionType.WARNING);
			}		
		}
	}
	...
	public void proceedButtonPolicyMemberAttributesNextGroupPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity){
		if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigProceedButton")) {
			click(nextButton);
			switchToFrame("display");
	...
	public void backButtonPolicyMemberAttributesNextGroupPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity){
	...
	public void submitPolicyMemberAttributesGroupPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity) {
		if (policyMemberAttrGroupEntity.getBooleanValueForField("ConfigSaveButton")) {
			click(saveButton);
			switchToFrame("display");
		}
	}
	...
	public void fillAndProceedPolicyMemberAttributesNextGroupPage(PolicyMemberAttrGroupEntity policyMemberAttrGroupEntity,CustomAssert assertReference)throws InterruptedException {
		if(isConfigTrue(policyMemberAttrGroupEntity.getConfigExecute())){
			switchToFrame("display");
			fillPolicyMemberAttributeNextGroupPage(policyMemberAttrGroupEntity, assertReference);
			proceedButtonPolicyMemberAttributesNextGroupPage(policyMemberAttrGroupEntity);
			fillGroupNumberDetails(policyMemberAttrGroupEntity, assertReference);
            clickOnNextButton(policyMemberAttrGroupEntity);
			fillMemberNumberDetails(policyMemberAttrGroupEntity, assertReference);
			submitPolicyMemberAttributesGroupPage(policyMemberAttrGroupEntity);
